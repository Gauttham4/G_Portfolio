...
const PROJECT_META: Record<string, { title: string; subtitle: string; description: string }> = {
  ...
  'divyadrishti':        { title: 'DivyaDrishti',       subtitle: 'Crowd-safety & predictive assist for events',                 description: 'A crowd-safety platform built for concerts, rallies, and first responders. Live density heatmap for officers, 90-second predictive surge alerts, safe-exit nudges for attendees, and a hold-to-confirm SOS path that survives peak-load mobile networks.' },
